...
MI_RGN_PaletteTable_t g_stPaletteTable = {{// index0 ~ index15
	...
	{0x70, 0xFF, 0x20, 0x10}, // Glow red: translucent, for the low-signal
							  // vignette (was an unused opaque dark red)
	{0xFF, 0xFF, 0x80, 0x00}, // Orange - threshold colours need a step between
							  // yellow and red (was an unused purple)
	{0x70, 0xFF, 0x90, 0x10}, // Glow orange: translucent, vignette warn step
							  // (was an unused orchid)
